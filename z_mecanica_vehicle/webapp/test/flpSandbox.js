		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comfiorizmecanicavehicle-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comfiorizmecanicavehicle-display": {
								"semanticObject": "comfiorizmecanicavehicle",
								"action": "display",
								"description": "App para cadastro de veículos",
								"title": "Cadastro de veículos",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.fiori.zmecanicavehicle",
									"url": sap.ui.require.toUrl("com/fiori/zmecanicavehicle")
								}
							}
						}
					}
