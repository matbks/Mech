		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comfiorizmecanicacustomer-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comfiorizmecanicacustomer-display": {
								"semanticObject": "comfiorizmecanicacustomer",
								"action": "display",
								"description": "ERP Mecanica",
								"title": "App Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.fiori.zmecanicacustomer",
									"url": sap.ui.require.toUrl("com/fiori/zmecanicacustomer")
								}
							}
						}
					}
